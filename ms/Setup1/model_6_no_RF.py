...
covariates_list = ["PROBABILITY"]

macau_covariates_list = ["gender_class","CIS","PP","PR","RR","SP","DURATION_OF_MS_AT_VISIT","age_at_onset_days_computed","last_EDSS","first_EDSS","diff_EDSS","max_previous_EDSS",'Relapses_in_observation_period', 'number_of_visits', 'Interferons',
       'Glatiramer', 'Alemtuzumab', 'other', 'Fingolimod', 'Natalizumab',
       'no_dmt_found', 'Teriflunomide', 'Cladribine', 'Dimethyl-Fumarate',
...
np.save("../comparisons_results/model6_noRF.npy",Model6_AUC)
np.save("../comparisons_results/model6_noRF_tpr.npy",np.array(Model6_TPR))
np.save("../comparisons_results/model6_noRF_fpr.npy",np.array(Model6_FPR))
np.save("../comparisons_results/model6_noRF_precision.npy",np.array(Model6_precision))
np.save("../comparisons_results/model6_noRF_recall.npy",np.array(Model6_recall))
